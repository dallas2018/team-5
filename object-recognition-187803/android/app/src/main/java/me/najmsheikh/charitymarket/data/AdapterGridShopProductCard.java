...
public class AdapterGridShopProductCard extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setOnMoreButtonClickListener(
            final OnMoreButtonClickListener onMoreButtonClickListener) {
        this.onMoreButtonClickListener = onMoreButtonClickListener;
    }

    public AdapterGridShopProductCard() {
        this.items = items;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            final Listing p = items.get(position);
    ...
    private void onMoreButtonClick(final View view, final Listing p) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, Listing obj, int pos);
    }

    public interface OnMoreButtonClickListener {
        void onItemClick(View view, Listing obj, MenuItem item);
    }
}