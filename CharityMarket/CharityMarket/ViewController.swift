...
class ViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBAction func login()
    {
        let marketVC = self.storyboard?.instantiateViewController(withIdentifier: "MarketPlaceViewController") as! MarketPlaceViewController
        self.present(marketVC, animated: true, completion: nil)
    }
